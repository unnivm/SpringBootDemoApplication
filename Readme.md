...
Admin user can download and insert the data into the in-memory database. This is a POST request and can be made only by user with admin right. The following image shows a POST request made by POSTMAN tool. I used POSTMAN tool to make a POST request.
